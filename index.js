...
async function main() {
  try {
    ...
    const file = await openai.files.create({
      file: fs.createReadStream("marble.md"),
      purpose: "assistants",
    });
    const assistant = await openai.beta.assistants.create({
      name: "Bob",
      instructions:
        "You are Bob - a marble, granite, quartz selling specialist.",
      tools: [
        {
    ...
    console.log(
      "\nHello there, I'm your personal Marble.com sales assistant. Ask some any questions about quartz.\n"
    );
